...
public final class PastSeekBarPreference extends DialogPreference implements OnSeekBarChangeListener {
    ...
    public PastSeekBarPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
